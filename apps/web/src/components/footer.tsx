    ...
    <footer className="bg-gray-900 text-white pt-20 pb-10">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-5 gap-8 mb-10">
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-4">
              <a href="https://www.facebook.com/pg/Winapps-PvtLtd-233477130147559/posts/" className="text-gray-400 hover:text-white">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M9 8h-3v4h3v12h5v-12h3.642l.358-4h-4v-1.667c0-.955.192-1.333 1.115-1.333h2.885v-5h-3.808c-3.596 0-5.192 1.583-5.192 4.615v3.385z" />
                </svg>
              </a>
              <a href="https://www.instagram.com/winapps_software/" className="text-gray-400 hover:text-white">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a href="https://www.linkedin.com/company/winapps.co.in/posts/?feedView=all" className="text-gray-400 hover:text-white">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="mailto:sales@winapps.co.in" className="text-gray-400 hover:text-white">
                  sales@winapps.co.in
                </a>
              </li>
              <li>
                <a href="skype:winapps.support?chat" className="text-gray-400 hover:text-white">
                  contractor.winapps
                </a>
              </li>
            </ul>
        ...
        <div className="border-t border-gray-800 pt-6 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-500 text-sm">&copy; 2025 Winapps. All rights reserved</p>
